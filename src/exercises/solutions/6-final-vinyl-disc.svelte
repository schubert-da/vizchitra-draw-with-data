<script>
	// Solution — Exercise 6 (the final project): every song as a full vinyl disc.
	// Four wedges radiate from the record's centre and corners — one per metric
	// (popularity, tempo, danceability, energy) — over a genre-coloured tile, with
	// a genre hub and the title/artist. This is the finished chart from the Solution
	// tab; from here, Section 5 has you tweak it with an AI agent to make it yours.
