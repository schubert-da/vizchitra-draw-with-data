...
<main class="mx-auto max-w-184 px-6 py-12 text-text sm:px-8 sm:py-16">
	...
	<p class="mb-6 text-[1.15rem] leading-relaxed text-text/80">
		Helloo there! Glad to see you here. This page walks you through getting your computer ready, one
		small step at a time. You don't need any coding experience - just follow along, and if something
		looks unfamiliar, that's totally normal.
	</p>
	...
	<div class="mb-10 rounded-lg border-l-4 border-palette-blue-dark bg-palette-blue/12 px-4 py-3">
		<p class=" text-[0.95rem] leading-relaxed">
			Set aside about <strong>15-20 minutes</strong>. You'll install two free programs and download
			the project. Take it slow - there's no rush, and you can't break anything.
		</p>
	</div>

	<p class="mb-5 block text-[0.95rem] leading-relaxed">
		<strong class="uppercase">Pro Tip</strong>: If you get stuck,
		<strong>ChatGPT is your friend</strong> - LLMs are surprisingly decent at explaining these kinds of
		things. Just copy the error message into ChatGPT and ask it to explain what it means and how to fix
		it.
	</p>
	...
	<section class="step">
		...
		<ol class="guide-list">
			...
			<li>
				Scroll down until you see the heading <strong>“Or get a prebuilt Node.js®”</strong>. This is
				the part you want - it has a couple of dropdowns and two green download buttons.
			</li>
			{#if os === 'mac'}
				<li>
				...
				<li>
					Open the downloaded <code>.pkg</code> file and click <em>Continue → Agree → Install</em>.
				</li>
			{:else}
				<li>
					Make sure the dropdowns say <strong>Windows</strong> and <strong>x64</strong> (the default
					on almost every PC), then click the green <strong>“Windows Installer (.msi)”</strong> button
					to download.
				</li>
				<li>
		...
		{#if os === 'mac'}
			<div class="callout callout--note">
				...
				<ul class="sub-list">
					<li>
						If it mentions <strong>Apple</strong> (e.g. “Apple M2”), choose <strong>arm64</strong>.
					</li>
		...
		<div class="callout callout--tip">
			...
			<p>
				...
				{#if os === 'mac'}<strong>Terminal</strong> app (press <kbd>⌘</kbd> + <kbd>Space</kbd>, type
					“Terminal”, hit Enter){:else}<strong>Command Prompt</strong> (press the Windows key, type “cmd”,
					hit Enter){/if} and type:
			</p>
		...
		<div class="callout callout--warning">
			...
			<p>
				If <code>node -v</code> says <em>“command not found”</em> or <em>“not recognized”</em>, the
				most common fix is simply to <strong>close that window and open a new one</strong> (or restart
		...
		<ol class="guide-list">
			...
			{:else}
				...
				<li>
					...
					checked - especially <strong>“Add to PATH”</strong> and <strong>“Open with Code”</strong>.
				</li>
	...
	<section class="step">
		...
		<ol class="guide-list">
			...
			{#if os === 'mac'}
				<li>
					Find the downloaded ZIP in <strong>Downloads</strong> and double-click it. macOS unzips it into
		...
		{#if os === 'windows'}
			<div class="callout callout--warning">
				...
				<p>
					When you double-click a ZIP, Windows shows you what's inside as if it were a normal folder
					- but it's still zipped. You <strong>must</strong> use <strong>“Extract All”</strong>
	...
	<section class="step">
		...
		<div class="callout callout--warning">
			...
			<p>
				Make sure you open the whole <strong>folder</strong> (the one with <code>package.json</code>
	...
	<section class="step">
		...
		<p>
			You'll see lots of text scroll by, and it may take a minute or two. When it stops and you get
			a fresh line to type on, it's done.
		</p>
	...
	<div class="mt-14 rounded-xl border border-text/12 bg-primary/5 px-6 py-6 text-center">
		...
		<p class="text-text/80">
			Head over to the <a href="/chapters" class="font-semibold">chapters</a> and start drawing with data.
		</p>
	</div>
</main>
